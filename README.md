# CSC207 Week 1 Lab Activity #1: Fizz Buzz RileyFewer
...
- [x] In the body of this main method, type `FizzBuzz_new.`. You'll see that the private helper method doesn't
...
- [x] In your main method in `Main.java`, try calling your private helper — something like `FizzBuzz_new.doFizzBuzz(5);`.
